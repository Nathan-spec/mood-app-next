    ...
    <div className='flex flex-col flex-1 gap-8 sm:gap-12 md:gap-16'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-5 gap-4'>
          {Object.keys(moods).map((mood, moodIndex) => {
            return (
              <button className={'p-4 rounded-lg purpleShadow duration-200 bg-indigo-50 hover:bg-indigo-100 text-center flex flex-col gap-2' + (moodIndex === 4 ? 'col-span-2' : ' ')} key={moodIndex}>
