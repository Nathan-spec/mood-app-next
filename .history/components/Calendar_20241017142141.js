...
export default function Calendar(props) {
  ...
  // const year = 2024
  // const month = 'July'
  const monthNow = new Date(selectedYear, Object.keys(months).indexOf
  (selectedMonth), 1)
  const firstDayOfMonth = monthNow.getDay()
  const daysInMonth = new Date(selectedY, Object.keys(selectedMonth).indexOf(selectedMonth) + 1, 0).getDate()
