...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <body
        className={' w-full, max-w-[1000px] mx-auto text-sm sm:text-base min-h-screen flex flex-col text-slate-800' ${openSans.className}  ${geistMono.variable} antialiased`}
      >
        {header}
        {children}
        {footer}
