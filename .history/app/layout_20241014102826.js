...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <body
        className={' w-full, max-w-[1000px] mx-auto text-sm sm:text-base min-h-screen flex flex-col text-slate-800' + opensa.className `${geistSans.variable} ${geistMono.variable} antialiased`}
      >
        {header}
        {children}
        {footer}
